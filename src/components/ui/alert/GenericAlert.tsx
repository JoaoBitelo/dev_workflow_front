...
const InfoModal: React.FC<InfoModalProps> = ({ isOpen, onClose, title, description, variant = "primary", cancel }) => {
    const iconColors: any = {
        success: "fill-success-600 dark:fill-success-500",
        danger: "fill-error-600 dark:fill-error-500",
        primary: "fill-blue-light-500 dark:fill-blue-light-500",
    };
    const svgColors: any = {
        success: "fill-success-50 dark:fill-success-500/15",
        danger: "fill-error-50 dark:fill-error-500/15",
        primary: "fill-blue-light-50 dark:fill-blue-light-500/15",
    };
        ...
        <Modal isOpen={isOpen} onClose={onClose} className="max-w-[600px] p-5 lg:p-10">
            <div className="text-center">
                ...
                <div className="flex items-center justify-center w-full gap-3 mt-7">
                    <Button variant={variant}>Continuar</Button>
                    {cancel && (
